    ...
    public partial class finanzappsdbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseMySql("server=10.0.0.72;port=3306;user=jvilchez;password=MySQL-server-2021;database=finanzappsdb;Convert Zero Datetime=True", Microsoft.EntityFrameworkCore.ServerVersion.Parse("8.0.25-mysql"));
            }
        }
